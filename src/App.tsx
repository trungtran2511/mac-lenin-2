                            ...
                            {qObj.options.map((option, idx) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`text-left p-4 rounded-2xl border text-[20px] font-medium leading-[28px] transition-all flex items-start justify-between gap-3 cursor-pointer break-words ${btnStyle}`}
                                >
